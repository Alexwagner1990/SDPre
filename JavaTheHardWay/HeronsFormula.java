...
// The version of the program that uses funcitons is shorter than the one that does not - functions do not require repeating formulas or assigning of variables.
// Since there is only one formula to fix in the fuctions version, the functions version is easier to debug.
